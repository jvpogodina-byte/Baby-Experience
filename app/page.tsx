      ...
      <section className="hero">
        <div className="container hero-grid">
          <div className="hero-panel">
            ...
            <p>
              Привет! Меня зовут Юля и я собрала для тебя подборки вещей, которые действительно пригодятся
              тебе и твоему малышу! Я постаралась быть максимально честной и объяснить в чем польза того или
              иного товара и на что нужно обратить внимание при выборе. Помни, что это лишь мое личное мнение
              и оно может отличаться от твоего💚
            </p>
          </div>
